                            ...
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                <table class="min-w-full divided-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <th scope="col" class="px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ">Name</th>
                                            <th scope="col" class="px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ">Status</th>
                                            <th scope="col" class="px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ">Role</th>
